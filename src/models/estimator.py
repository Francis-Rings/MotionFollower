...
@dataclass
class EstimatorOutput(BaseOutput):
    sample: torch.FloatTensor

class Estimator(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if up_ft_indices is None:
            ...
            return EstimatorOutput(sample=sample)

        elif up_ft_indices is not None:
            up_ft = []
            for i, upsample_block in enumerate(self.up_blocks):
