    ...
    def forward(
        ...
        for i, (resnet, attn, motion_module) in enumerate(
            ...
            if self.training and self.gradient_checkpointing:
                ...
                if ((idx+1)%3 == 0) and appearance_feature is not None and len(appearance_feature):
                    hidden_states = hidden_states + appearance_feature
                idx = idx + 1
...
class DownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, appearance_feature=None):
        output_states = ()
        idx = 1
