...
@dataclass
class Pose2VideoCollectionPipelineOutput(BaseOutput):
    videos: Union[torch.Tensor, np.ndarray]
    collections: torch.Tensor
    latents_org: torch.Tensor


class Pose2VideoCollectionPipeline(DiffusionPipeline):
    ...
    def __init__(
        ...
        self.ddim_inv_scheduler = ddim_inv_scheduler
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents_collection = latents_collection[::-1]
        print(f"the length of latents collection: {len(latents_collection)}")
        # Post-processing
        ...
        return Pose2VideoCollectionPipelineOutput(videos=images, collections=latents_collection, latents_org=latents_org)
